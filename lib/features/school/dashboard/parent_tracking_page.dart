...
class _ParentTrackingPageState extends State<ParentTrackingPage> {
  ...
  Widget build(BuildContext context) => WorkspacePage(
        ...
        subtitle:
            'Présence, comportement et progression générale à partir des données officielles',
        actions: [
    ...
    return Column(
      ...
      children: [
        ...
        AppCard(
          ...
          subtitle:
              'Le détail des matières, devoirs, compositions et examens reste dans le module « Notes des enfants ».',
          child: const Text(
            'Cette page présente uniquement les indicateurs synthétiques de suivi.',
          ),
        ),
      ],
    );
