...
class StudentRegistrationModel {
  ...
  final List<Map<String, dynamic>> schoolRegimeHistory;
  ...
  StudentRegistrationModel({
    ...
    this.cycleCode,
    this.schoolRegime,
    this.schoolRegimeHistory = const [],
    this.status = 'pending',
    this.feeIds = const [],
    this.type,
    this.createdAt,
  ...
  factory StudentRegistrationModel.fromJson(Map<String, dynamic> json) {
    return StudentRegistrationModel(
      ...
      schoolRegimeHistory: (json['schoolRegimeHistory'] as List? ?? const [])
  ...
  Map<String, dynamic> toJson() => {
    ...
    'schoolRegimeHistory': schoolRegimeHistory,
    'status': status,
    'feeIds': feeIds,
    'type': type,
    'createdAt': createdAt,
