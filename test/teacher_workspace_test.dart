...
void main() {
  ...
  testWidgets(
    ...
    expect(
      find.byKey(
          const ValueKey('combined-presence-evaluation-1|student-1')),
      findsNothing,
    );
    expect(find.text('État'), findsNothing);
    expect(find.text('Note, ABS ou vide'), findsWidgets);
    expect(tester.takeException(), isNull);
  });
